...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 antialiased">
      {/* ✅ Auth Modals */}
      <LoginForm open={openLogin} onClose={closeAll} onShowRegister={switchToRegister} />
      <RegisterForm open={openRegister} onClose={closeAll} onShowLogin={switchToLogin} />
      ...
      <main>
        ...
        <section id="hero" className="relative overflow-hidden scroll-mt-24">
          ...
          <svg
            className="absolute left-0 right-0 top-8 mx-auto h-40 w-full max-w-6xl opacity-30"
            viewBox="0 0 800 200"
            ...
            <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
              <motion.div initial="initial" animate="animate" variants={fadeInRight}>
                <h1 className="text-4xl font-extrabold leading-tight sm:text-5xl">
                  ...
                  with
                  <br /> the Power of <span className="text-indigo-600">AI</span> &amp;{" "}
                  <span className="text-pink-500">Big Data</span>
                </h1>
                ...
                >
                  A smart health platform that monitors community health trends, predicts outbreaks, and supports early
                  interventions.
                </motion.p>
              ...
              <motion.div className="flex items-center justify-center" variants={floatAnimation} animate="animate">
                <div className="h-64 w-64 md:h-80 md:w-80 lg:h-96 lg:w-96 flex items-center justify-center">
                  <img src="/robot.svg" alt="robot" className="h-55 w-55 md:h-100 md:w-100 object-contain" />
                </div>
              </motion.div>
            </div>
          </div>
        ...
        <motion.section
          id="mission"
          ref={missionRef}
          className="relative mx-auto max-w-4xl px-6 py-12 text-center scroll-mt-24"
          initial={{ opacity: 0, y: 30 }}
        ...
        >
          ...
          <p className="mt-4 text-gray-600 relative z-10">
            We aim to revolutionize public health monitoring by combining AI, big data, and behavioral analytics. Our
  ...
  >
    Turning individual health signals into global awareness
        ...
        <motion.section
          id="how"
          ref={howRef}
          className="relative mx-auto max-w-6xl px-6 py-12 scroll-mt-24"
          initial={{ opacity: 0, y: 30 }}
                  ...
                  >
                    <motion.div
                      className={`mb-4 flex h-10 w-10 items-center justify-center rounded-full ${
                        i === 2 ? "bg-indigo-600 text-white" : "bg-white border"
                      } shadow`}
                    ...
                    <div className="text-sm text-gray-600 hover:text-indigo-600 transition-colors duration-200">
                      {step}
                    </div>
                  </motion.li>
                ))}
        ...
        >
          ...
          <p className="mt-2 text-center text-gray-600 relative z-10">
            Real experiences from students, analysts, and health enthusiasts.
          </p>
            ...
            {[
              {
                ...
                role: "Epidemiologist",
                comment:
                  "This platform helped our team predict outbreaks earlier and allocate resources efficiently. The AI models are incredibly accurate!",
                rating: "★★★★★",
              },
              {
                ...
                comment:
                  "As a student, the educational resources and real-time data have been invaluable for my research projects and understanding of epidemiology.",
                rating: "★★★★★",
              },
              {
                ...
                comment:
                  "The predictive analytics have transformed how we prepare for seasonal illnesses. We've reduced response time by 40% using this system.",
                rating: "★★★★☆",
              },
              ...
              >
                ...
                <div className="mt-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold hover:text-indigo-600 transition-colors duration-200">
                        {testimonial.name}
                      </div>
